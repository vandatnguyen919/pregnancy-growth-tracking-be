    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(authorizeHttpRequests -> authorizeHttpRequests
                        ...
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/users/**").hasAnyRole("admin", "member", "user") // Protect this endpoint
...
//                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/v1/payment/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/v1/fetuses/**").authenticated()
                        .requestMatchers(HttpMethod.POST, this.baseUrl + "/v1/fetuses").authenticated()
                        .requestMatchers(HttpMethod.PUT, this.baseUrl + "/v1/fetuses/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE, this.baseUrl + "/v1/fetuses/**").authenticated()
                        .requestMatchers(HttpMethod.GET, this.baseUrl + "/v1/fetus-metrics/**").authenticated()
